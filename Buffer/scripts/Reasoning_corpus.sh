...
# Set Python path
PATH_TO_ARPO="./Buffer"
export PYTHONPATH="${PATH_TO_ARPO}/verl_arpo_entropy:$PYTHONPATH"

# ============================ Basic Configuration ============================
# Experiment name and project
PROJECT_NAME="rollout_tasks" # Modify experiment group
EXPERIMENT_NAME="Rollout_Qwen_14B_AEPO_reasoning_train" # Modify experiment name
...
NNODES=1                            
N_GPUS_PER_NODE=4
export CUDA_VISIBLE_DEVICES=1,2,3,4 # 0,1,2,3  # List of visible GPUs
...
# ============================ Model Configuration ============================
# Actor model path
ACTOR_MODEL_PATH=dongguanting/Qwen3-14B-AEPO-DeepSearch   # Modify training model path
...
CUSTOM_REWARD_FUNCTION_PATH="${PATH_TO_ARPO}/verl_arpo_entropy/verl/utils/reward_score/deep_research.py" # Modify reward function path
CUSTOM_REWARD_FUNCTION_NAME="compute_score"

# ============================ Training Configuration ============================
# Training parameters
TOTAL_EPOCHS=1                      # Total training epochs
SAVE_FREQ=1000000                        # Save frequency
TEST_FREQ=1000000                        # Test frequency
