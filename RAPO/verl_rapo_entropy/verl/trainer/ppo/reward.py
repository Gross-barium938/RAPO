...
def compute_reward(data: DataProto, reward_fn):
    ...
    try:
        ...
        retrieve_gates = reward_result["retrieve_gates"]
        retrieve_rewards = reward_result["retrieve_rewards"]
        retrieve_token_ratios = reward_result["retrieve_token_ratios"]
        ...
        retrieve_gates = None
        retrieve_rewards = None
        retrieve_token_ratios = None

    return reward_tensor, reward_extra_infos_dict, retrieve_gates, retrieve_rewards, retrieve_token_ratios
